# 2015.11.18 11:54:39 Støední Evropa (bìžný èas)
...
class Store(LobbySubView, StoreMeta):
    ...
    def _clearTableData(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\store\store.pyc 
