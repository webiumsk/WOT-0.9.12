# 2015.11.18 11:56:50 Støední Evropa (bìžný èas)
...
class CustomizationBonusTooltip(BlocksTooltipData):
    ...
    def __getData(self, singleBonusData, qTypeName):
        ...
        return item
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\tooltips\customizationbonus.pyc 
